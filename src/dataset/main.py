...
class FineWebDatasetDownloader:
    ...
    def __init__(self, num_samples: int = 50000, output_dir: str = "data"):
        """
        Initialize the dataset downloader.
        
        Args:
            num_samples: Number of samples to download (default: 50000)
...
def main():
    ...
    downloader = FineWebDatasetDownloader(num_samples=50000)
